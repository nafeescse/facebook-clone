    ...
    return (
        <div className='bg-base-300 px-32 py-3 flex justify-center gap-2'>
            ...
            <div className=''>
                ...
                {/* Posts */}
                <div class="card w-[570px] bg-base-100 shadow-xl rounded-md mb-2">
                    <div class="card-body">
                ...
                <div class="card w-[570px] bg-base-100 shadow-xl rounded-md mb-2 flex">
                ...
                <div class="card w-[570px] bg-base-100 shadow-xl rounded-md mb-2">
                    <div class="card-body">
                        ...
                        <div className='flex gap-2'>
                            <img src="https://placeimg.com/250/250/arch" alt="" />
                            <img src="https://placeimg.com/250/250/arch" alt="" />
                        </div>
                        <div className='flex gap-2'>
                            <img src="https://placeimg.com/164/164/arch" alt="" />
                            <img src="https://placeimg.com/164/164/arch" alt="" />
                            <img src="https://placeimg.com/164/164/arch" alt="" />
                        </div>
                ...
                <div class="card w-[570px] bg-base-100 shadow-xl rounded-md mb-2">
                    <div class="card-body">
                        <div className='flex items-center gap-2'>
                            ...
                            <div>
                                <p className='font-bold flex gap-2'>Alfred Parchment <small className='flex items-center gap-2 text-slate-500'> Updated her profile picture</small></p>
                ...
                <div class="card w-[570px] bg-base-100 shadow-xl rounded-md mb-2">
                    <div class="card-body">
                        <div className='flex items-center gap-2'>
                            ...
                            <div>
                                <p className='font-bold flex gap-2'>Shakil Ahmed <span className='flex items-center gap-2 text-black'><FaArrowAltCircleRight /> BLACK BUSINESS OWNERS</span></p>
                ...
                <div class="card w-[570px] bg-base-100 shadow-xl rounded-md mb-2">
                    <div class="card-body">
                        ...
                        <div className="bg-gradient-to-r from-red-700 to-blue-800 w-[520px] h-[400px] static z-0 rounded-md"><p className='absolute top-56 left-14 z-10 text-3xl font-bold text-white text-center'>Click your home icon to rerfresh feed !</p></div>
                ...
                <div class="card w-[570px] bg-white shadow-xl rounded-md mb-2">
                    <div class="card-body">
